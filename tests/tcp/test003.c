...
// /**
//  * TEST CASE 3: blocking server and client
// */
...
// static int test003_server_connect = 0;
// static int test003_server_data = 0;
// static int test003_server_disconnect = 0;
// static int test003_client_connect = 0;
// static int test003_client_data = 0;
// static int test003_client_disconnect = 0;
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] server failed to accept incoming connection\nerrno: %d\nerrno reason: %d\n%s", accept_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         test003_server_connect++;
//         printf("[TEST CASE 003] new socket connected. socket id: %d\n", client->socket_fd);
//     }
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] server failed to receive data from client\nerrno: %d\nerrno reason: %d\n%s", recv_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         test003_server_data++;
//         printf("[TEST CASE 003] server received data from client! %s\n", buffer);
//     }

//     int send_result;
//     if ((send_result = server_send(client, "hello from server", 17)) != 0)
//     {
//         printf(ANSI_RED "[TEST CASE 003] server failed to send data to client\nerrno: %d\nerrno reason: %d\n%s", send_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         printf("[TEST CASE 003] server sent data to client!\n");
//     }
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] server failed to disconnect from client\nerrno: %d\nerrno reason: %d\n%s", disconnect_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         test003_server_disconnect++;
//         printf("[TEST CASE 003] server disconnected from client!\n");
//     }
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] client failed to connect\nerrno: %d\nerrno reason: %d\n%s", connect_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         test003_client_connect++;
//         printf("[TEST CASE 003] client connected to server!\n");
//     }

//     int send_result = 0;
//     if (client_send(client, "hello from client", 17) != 0)
//     {
//         printf(ANSI_RED "[TEST CASE 003] client failed to send data to server\nerrno: %d\nerrno reason: %d\n%s", send_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         printf("[TEST CASE 003] client sent data to server!\n");
//     }
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] client failed to receive data from server\nerrno: %d\nerrno reason: %d\n%s", recv_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         test003_client_data++;
//         printf("[TEST CASE 003] client received data from server! %s\n", buffer);
//     }

//     int disconnect_result = 0;
//     if ((disconnect_result = client_close(client, 0)) != 0)
//     {
//         printf(ANSI_RED "[TEST CASE 003] client failed to disconnect from server\nerrno: %d\nerrno reason: %d\n%s", disconnect_result, netc_errno_reason, ANSI_RESET);
//         return NULL;
//     } else {
//         test003_client_disconnect++;
//         printf("[TEST CASE 003] client disconnected from server!\n");
//     }
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] server failed to initialize\nerrno: %d\nerrno reason: %d\n%s", init_result, netc_errno_reason, ANSI_RESET);
//         return 1;
//     };
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] server failed to bind\nerrno: %d\nerrno reason: %d\n%s", bind_result, netc_errno_reason, ANSI_RESET);
//         return 1;
//     };
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] server failed to listen\nerrno: %d\nerrno reason: %d\n%s", listen_result, netc_errno_reason, ANSI_RESET);
//         return 1;
//     };

//     printf("[TEST CASE 003] server listening on port %d\n", PORT);
...
//     {
//         printf(ANSI_RED "[TEST CASE 003] client failed to initialize\nerrno: %d\nerrno reason: %d\n%s", client_init_result, netc_errno_reason, ANSI_RESET);
//         return 1;
//     };
...
//     if (test003_server_connect != 1) printf(ANSI_RED "\n\n\n[SERVER_CONNECT] server failed to accept incoming connection\n" ANSI_RESET);
//     else printf(ANSI_GREEN "\n\n\n[SERVER_CONNECT] server accepted incoming connection\n" ANSI_RESET);

//     if (test003_server_data != 1) printf(ANSI_RED "[SERVER_DATA] server failed to receive data from client\n" ANSI_RESET);
//     else printf(ANSI_GREEN "[SERVER_DATA] server received data from client\n" ANSI_RESET);

//     if (test003_server_disconnect != 1) printf(ANSI_RED "[SERVER_DISCONNECT] server failed to disconnect from client\n" ANSI_RESET);
//     else printf(ANSI_GREEN "[SERVER_DISCONNECT] server disconnected from client\n" ANSI_RESET);

//     if (test003_client_connect != 1) printf(ANSI_RED "[CLIENT_CONNECT] client failed to connect to server\n" ANSI_RESET);
//     else printf(ANSI_GREEN "[CLIENT_CONNECT] client connected to server\n" ANSI_RESET);

//     if (test003_client_data != 1) printf(ANSI_RED "[CLIENT_DATA] client failed to receive data from server\n" ANSI_RESET);
//     else printf(ANSI_GREEN "[CLIENT_DATA] client received data from server\n" ANSI_RESET);

//     if (test003_client_disconnect != 1) printf(ANSI_RED "[CLIENT_DISCONNECT] client failed to disconnect from server\n\n\n" ANSI_RESET);
//     else printf(ANSI_GREEN "[CLIENT_DISCONNECT] client disconnected from server\n\n\n" ANSI_RESET);

//     return 
//         (int)(!(test003_server_connect == 1 && test003_server_data == 1 && test003_server_disconnect == 1 && test003_client_connect == 1 && test003_client_data == 1 && test003_client_disconnect == 1));
// };
